...
<div id="page-wrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Data Menunggu Persetujuan</h1>
			</div><!-- /.col-lg-12 -->
		</div><!-- /.row -->
				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						$Sql = "SELECT
								...
								WHERE pengajuan_jaminan.status = 'Pending'
						...
						<table class="table table-striped table-bordered table-hover" id="tabel-data">
							...
							<tbody>
								...
								while ($data = mysqli_fetch_array($Qry)) {
									...
									<a href="approval_review.php?id=<?php echo $data['id_pengajuan']; ?>" class="btn btn-primary btn-xs">Review</a></td>
								<?php
									echo '</td>';
									echo '</tr>';
									$i++;
...
<script>
	...
	$('[data-load-code]').on('click', function(e) {
		...
		if (code) {
			$($this.data('remote-target')).load('jaminan_detail.php?code=' + code);
			app.code = code;
		}
	});
