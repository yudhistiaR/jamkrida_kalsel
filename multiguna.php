...
<div id="page-wrapper">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">Data Multiguna</h1>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        WHERE pengajuan_jaminan.type_jaminan = 'multiguna'
        ORDER BY pengajuan_jaminan.id ASC";
                ...
                ?>
                  <tr>
                    ...
                    <td class="text-center">
                      ...
                      <a href="multiguna_edit.php?id=<?= $data['id_pengajuan']; ?>" class="btn btn-warning btn-xs">Edit</a>
            ...
            <div class="form-group">
									<a href="laporan_cetak.php?type=multiguna" target="_blank" class="btn btn-warning">Cetak</a>
							</div>
          </div>
...
<script>
  ...
  $('[data-load-code]').on('click', function(e) {
    ...
    if (code) {
      $($this.data('remote-target')).load('multiguna_detail.php?code=' + code);
      app.code = code;
    }
  });
</script>
