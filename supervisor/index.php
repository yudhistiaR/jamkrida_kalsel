<?php
	...
	$sqld = "SELECT * FROM cuti WHERE spv='$id' AND stt_cuti='Menunggu Perstujuan Supervisor'";
	$ressd = mysqli_query($conn, $sqld);
	$d = mysqli_num_rows($ressd);

	$sqle = "SELECT * FROM cuti WHERE spv='$id'";
				...
				<div class="row">
					<div class="col-lg-12">
						<form class="form-horizontal">
							<div class="panel panel-default">
								<div class="panel-body">
								<h2 align="center">Persetujuan Pengajuan Cuti</h2>
								</div>
							</div><!-- /.panel -->
						</form>
					</div><!-- /.col-lg-12 -->
